...
@Component({
  selector: 'app-registrar-ca',
  templateUrl: './registrar-ca.component.html',
  styleUrls: [ './registrar-ca.component.css']
})
export class RegistrarCAComponent implements OnInit {
  form: FormGroup;
